 ...
 const MatchCard = ({ profile, onFlip, }: { profile: Profile; onFlip: () => void; }) => {
  ...
  return (
    <Container id="bg-image" className="card-page-container py-5 justify-content-center" style={{ height: '87vh' }} fluid>
          ...
          <Card.Header className="" style={{backgroundColor: 'var(--manoa-green)'}}>
          ...
          <Card.Body className="card-body d-flex pb-5">
            <Col className="ms-3 me-2">
              ...
              <Icon.ThreeDots className="w-75 mt-2 d-block mx-auto" size='25px' />
              <p className="mb-4 mt-2 text-center" style={{ fontStyle: 'italic' }}>
                {profile.description}
                </p>
              </Col>
              <Col lg={10} className="mt-1 ms-4 pt-4">
                  ...
                  <p className="text-dark"  style={{fontSize: '1.1rem'}}>
                    <Icon.MortarboardFill className="me-2 mb-1" size="25px" />{`${profile.year}`}
                    <span className="mx-1"> | </span>
                    <Icon.SuitcaseLg className="ms-1 me-2 mb-1" size="25px" />{profile.major} Major
                    <span className="mx-1"> | </span>
          ...
          <Card.Footer className="m-0 p-0 d-flex border-0 py-2 justify-content-end">
            <Button 
                ...
                onClick={onFlip}>
                  More<Icon.ArrowRight className="ms-1 mb-1 text-light" size="15px" />
            </Button>
          </Card.Footer>
          </Card>
