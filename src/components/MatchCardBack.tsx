        ...
        <Card.Body className="card-body d-block pb-5 align-middle">
          <Row className="align-items-center align-middle mt-4">
            <Col className="justify-content-center">
              ...
              <Icon.Mortarboard className="me-2 mb-1" size="25px" />{`${profile.year}`}
              <span className="mx-1"> | </span>
              <Icon.SuitcaseLg className="ms-1 me-2 mb-1" size="25px" />{profile.major}
              <span className="mx-1"> | </span>
              <Icon.Person className="ms-1 me-2 mb-1" size="25px" />{profile.mbti}
              </p>
          ...
          <Row className="align-middle px-4 mt-1"> 
            ...
            <strong className="mt-2" style={{ fontSize: '1.3rem' }}>
              <Icon.PersonFill className="mb-1 me-1" size="20px" />About Me
            </strong><br />
              ...
              <p className="mb-4 mt-2">
                <strong style={{ fontSize: '1.3rem' }}>
                  <Icon.PatchCheckFill className="mb-1 me-1" size="20px" />Interests
                </strong><br />
                {profile.likes}
              </p>
            </Col>           
            <Col>
              <p>
                <strong style={{ fontSize: '1.3rem' }} className="text-center me-2">
                  <Icon.BusFront className="mb-1 me-1" size="20px" />Commute Status
                </strong>
              ...
              <p>
                <strong style={{ fontSize: '1.3rem' }} className="text-center me-2">
                  <Icon.PersonArmsUp className="mb-1 me-1" size="20px" />Clubs
                </strong>
              ...
              <p>
                <strong style={{ fontSize: '1.3rem' }} className="text-center me-2">
                  <Icon.GlobeAmericas className="mb-1 me-1" size="20px" />Languages
                </strong>
            ...
            <Col className="justify-content-center align-middle text-center">
              <Row className="px-5">
                ...
                >
                  <Icon.BookmarkFill className="mb-1 me-1" size="18px"/>Courses
                </strong><br />
              </Row>
            ...
            <Navbar className="m-0 p-0 d-flex">
              ...
              <Col className="m-0 p-0 justify-content-end d-flex">
                <Button 
                  ...
                  onClick={onFlipBack}>
                    Back<Icon.ArrowLeft className="ms-1 mb-1 text-light" size="15px" />
                </Button>
              </Col>
            </Navbar>
          </Card.Footer>
